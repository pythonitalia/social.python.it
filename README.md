...
3. Then, create DNS records for your custom domain.
   ...
   If your DNS host only allows A records, use the IP. For example, if your IP
   was `3.3.3.3`:
...
If there are migrations that must be run before deploying to avoid downtime, you
